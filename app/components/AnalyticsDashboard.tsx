      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-card p-6 hover:scale-105 transition-transform">
          <div className="flex items-center justify-between mb-2">
            <span className="text-lightblue text-sm font-medium">Total Scans</span>
            <svg className="w-6 h-6 text-sui-blue" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="text-xs text-lightblue/60 mt-2">Transactions analyzed</div>
        </div>

        {/* Value Protected */}
        <div className="glass-card p-6 hover:scale-105 transition-transform">
          <div className="flex items-center justify-between mb-2">
            <span className="text-lightblue text-sm font-medium">Value Protected</span>
          ...
          <div className="text-xs text-lightblue/60 mt-2">Assets saved from scams</div>
        </div>

        {/* Scams Blocked */}
        <div className="glass-card p-6 hover:scale-105 transition-transform">
          <div className="flex items-center justify-between mb-2">
            <span className="text-lightblue text-sm font-medium">Scams Blocked</span>
          ...
          <div className="text-xs text-lightblue/60 mt-2">Dangerous transactions flagged</div>
        </div>
