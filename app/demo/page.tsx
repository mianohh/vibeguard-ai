  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 max-w-6xl">
        ...
        <div className="glass-card p-8 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-400 text-sm">Connected: 0x742d...89a3</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
              <span className="text-green-400 text-sm font-semibold">Protected by VibeGuard</span>
            </div>
          </div>

          <div className="grid grid-cols-3 gap-4 p-4 bg-ocean-mid/30 rounded-lg border border-ocean-surface">
            <div>
            ...
            {DEMO_SCENARIOS.map((scenario) => (
              <button
                ...
                className={`
                  ...
                  ${selectedScenario?.id === scenario.id ? 'ring-2 ring-sui-cyan' : ''}
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <div className={`
                    ...
                    ${scenario.riskLevel === 'GREEN' ? 'bg-status-safe' : 'bg-status-danger'}
                  `}></div>
                  <span className={`
                    text-xs font-semibold
                    ${scenario.riskLevel === 'GREEN' ? 'text-status-safe' : 'text-status-danger'}
                  `}>
        ...
        {selectedScenario && (
          <div className="glass-card p-8 mb-8 liquid-expand">
            ...
            <div className="mb-6 p-4 bg-ocean-mid/30 rounded-lg border border-ocean-surface">
              <div className="text-gray-400 text-xs mb-2">TRANSACTION BYTES</div>
            ...
            {showResult && (
              <div className={`
                p-6 rounded-lg border-2 animate-fadeIn
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3 text-sm">
                      <div>
                        <div className="text-gray-400 mb-1">You Expected:</div>
                        <div className="text-white font-medium">{selectedScenario.expectedOutcome}</div>
                      </div>
                      <div>
                        <div className="text-gray-400 mb-1">What Actually Happens:</div>
                        <div className={`
                          font-medium
        ...
        <div className="glass-card p-8">
          <h3 className="text-2xl font-bold text-white mb-4">Wallet Integration</h3>
          <p className="text-gray-400 mb-6">
            Add VibeGuard protection to your wallet or dApp with 3 lines of code:
          </p>
          
          <pre className="bg-ocean-deepest p-6 rounded-lg border border-ocean-surface overflow-x-auto">
...
function AnalysisStep({ 
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      {status === 'active' && (
        <div className="w-5 h-5 border-2 border-sui-cyan/30 border-t-sui-cyan rounded-full animate-spin"></div>
      )}
    </div>
  );
}
